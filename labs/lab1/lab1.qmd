...
<!--
To calculate the pull down resistors for the seven segement display, I used the datasheet of the display itself.
I chose to use 1k $\Omega$ as it fell within the maximum range.
-->
